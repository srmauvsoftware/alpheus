...
"""autogenerated by genpy from alpheus_actions/headingActionResult.msg. Do not edit."""
import sys
...
class headingActionResult(genpy.Message):
  _md5sum = "2063ef01ee096ee0677819d63f963ae4"
  _type = "alpheus_actions/headingActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','alpheus_actions/headingResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(headingActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = alpheus_actions.msg.headingResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = alpheus_actions.msg.headingResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_f().pack(self.result.heading_final))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.heading_final,) = _get_struct_f().unpack(str[start:end])
      return self
