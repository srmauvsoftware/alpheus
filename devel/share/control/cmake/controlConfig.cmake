...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/pushkalkatara/Desktop/PUbuntu/AUV/alpheus/src/control)
  set(control_DEVEL_PREFIX /home/pushkalkatara/Desktop/PUbuntu/AUV/alpheus/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/pushkalkatara/Desktop/PUbuntu/AUV/alpheus/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Pushkal Katara <katarapushkal@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pushkalkatara/Desktop/PUbuntu/AUV/alpheus/src/control/${idir}'.  Ask the maintainer 'Pushkal Katara <katarapushkal@gmail.com>' to fix it.")
    endif()
